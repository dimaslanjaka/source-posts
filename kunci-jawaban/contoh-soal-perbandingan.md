...
<p>
\[ Uang Fadil = { 8 \over 8 + 12 + 15 } \times 3500000 \]
\[ Uang Fadil = { 8 \over 35 } \times 3500000 \]
\[ Uang Fadil = 800000 \]
</p>
...
<p>
\[ \displaylines{ p = { 3 \over (2+3) } \times 20
\\ { p = {3 \over 5 } \times 20} = { (3 \times 20) \over 5 } = { 60 \over 5 } = 12 }  \]
</p>
...
Berarti : ___Kelereng A + kelereng B = 70___
...
<li><p>untuk mendapatkan <b>n</b>, maka 70 harus dibagi dengan 10 ( \( 70 \div 10 \) )</p></li>
...
<li><p>\( n = 7 \) (sesuai perhitungan di atas)</p></li>
...
<p>Kelereng \( A = 21 \) buah</p>
<p>Kelereng \( B = 49 \) buah</p>
