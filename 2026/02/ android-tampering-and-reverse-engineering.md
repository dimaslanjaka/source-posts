---
title: Android Tampering and Reverse Engineering
date: 2020-10-24T08:34:19Z
tags:
    - android
category: []
updated: 2026-02-14T08:34:32Z
categories:
    - programming
---
...
Note that we'll use the [OWASP Mobile Testing Guide Crackmes](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Crackmes/ "UnCrackable Mobile Apps") as examples for demonstrating various reverse engineering techniques in the following sections, so expect partial and full spoilers. We encourage you to have a crack at the challenges yourself before reading on!

[](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#reverse-engineering)Reverse Engineering
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#tooling)Tooling

Make sure that the following is installed on your system (see the "[Android Basic Security Testing](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05b-Basic-Security_Testing.md)" chapter for installation instructions):
...
In addition to the SDK and NDK, you'll also need something to make Java bytecode more human-readable. Fortunately, Java decompilers generally handle Android bytecode well. Popular free decompilers include [JD](https://web.archive.org/web/20201024220933/http://jd.benow.ca/ "JD"), [JAD](https://web.archive.org/web/20201024220933/http://www.javadecompilers.com/jad "JAD"), [Procyon](https://web.archive.org/web/20201024220933/https://github.com/mstrobel/procyon "Procyon"), and [CFR](https://web.archive.org/web/20201024220933/https://www.benf.org/other/cfr/ "CFR"). For convenience, we have packed some of these decompilers into our [apkx wrapper script](https://web.archive.org/web/20201024220933/https://github.com/b-mueller/apkx "apkx - APK Decompilation for the Lazy"). This script completely automates the process of extracting Java code from release APK files and makes it easy to experiment with different backends (we'll also use it in some of the following examples).
...
#### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#building-a-reverse-engineering-environment-for-free)Building a Reverse Engineering Environment for Free

With a little effort, you can build a reasonable GUI-based reverse engineering environment for free.

For navigating the decompiled sources, we recommend [IntelliJ](https://web.archive.org/web/20201024220933/https://www.jetbrains.com/idea/ "IntelliJ IDEA"), a relatively lightweight IDE that works great for browsing code and allows basic on-device debugging of the decompiled apps. However, if you prefer something that's clunky, slow, and complicated to use, [Eclipse](https://web.archive.org/web/20201024220933/https://eclipse.org/ide/ "Eclipse") is the right IDE for you (based on the author's personal bias).

If you don't mind looking at Smali instead of Java, you can use the [smalidea plugin for IntelliJ](https://web.archive.org/web/20201024220933/https://github.com/JesusFreke/smalidea "Smalidea") for debugging. Smalidea supports single-stepping through the bytecode and identifier renaming, and it watches for non-named registers, which makes it much more powerful than a JD + IntelliJ setup.

[apktool](https://web.archive.org/web/20201024220933/https://github.com/iBotPeaches/Apktool "apktool") is a popular free tool that can extract and disassemble resources directly from the APK archive and disassemble Java bytecode to Smali format (Smali/Baksmali is an assembler/disassembler for the Dex format. It's also Icelandic for "Assembler/Disassembler"). apktool allows you to reassemble the package, which is useful for patching and applying changes to the Android Manifest.

You can accomplish more elaborate tasks (such as program analysis and automated de-obfuscation) with open source reverse engineering frameworks such as [Radare2](https://web.archive.org/web/20201024220933/https://www.radare.org/ "Radare2"), [Ghidra](https://web.archive.org/web/20201024220933/https://ghidra-sre.org/ "Ghidra") and [Angr](https://web.archive.org/web/20201024220933/https://angr.io/ "Angr"). You'll find usage examples for many of these free tools and frameworks throughout the guide.

#### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#commercial-tools)Commercial Tools
...
#### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#decompiling-java-code)Decompiling Java Code
...
[![Crackme](https://web.archive.org/web/20201024220933im_/https://github.com/OWASP/owasp-mstg/raw/master/Document/Images/Chapters/0x05c/crackme-1.png)](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/Images/Chapters/0x05c/crackme-1.png)
...
[![](https://web.archive.org/web/20201024220933im_/https://github.com/OWASP/owasp-mstg/raw/master/Document/Images/Chapters/0x05c/intellij_new_project.jpg)](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/Images/Chapters/0x05c/intellij_new_project.jpg)
...
[![Delete default package](https://web.archive.org/web/20201024220933im_/https://github.com/OWASP/owasp-mstg/raw/master/Document/Images/Chapters/0x05c/delete_package.jpg)](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/Images/Chapters/0x05c/delete_package.jpg)
...
[![](https://web.archive.org/web/20201024220933im_/https://github.com/OWASP/owasp-mstg/raw/master/Document/Images/Chapters/0x05c/drag_code.jpg)](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/Images/Chapters/0x05c/drag_code.jpg)

You'll end up with a structure that resembles the original Android Studio project from which the app was built.

[![Final Structure](https://web.archive.org/web/20201024220933im_/https://github.com/OWASP/owasp-mstg/raw/master/Document/Images/Chapters/0x05c/final_structure.jpg)](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/Images/Chapters/0x05c/final_structure.jpg)

See the section "[Reviewing Decompiled Java Code](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#reviewing-decompiled-java-code "Reviewing Decompiled Java Code")" below to learn on how to proceed when inspecting the decompiled Java code.

#### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#disassembling-native-code)Disassembling Native Code

Dalvik and ART both support the Java Native Interface (JNI), which defines a way for Java code to interact with native code written in C/C++. As on other Linux-based operating systems, native code is packaged (compiled) into ELF dynamic libraries (*.so), which the Android app loads at runtime via the `System.load` method. However, instead of relying on widely used C libraries (such as glibc), Android binaries are built against a custom libc named [Bionic](https://web.archive.org/web/20201024220933/https://github.com/android/platform_bionic "Bionic libc"). Bionic adds support for important Android-specific services such as system properties and logging, and it is not fully POSIX-compatible.
...
[![Hello World](https://web.archive.org/web/20201024220933im_/https://github.com/OWASP/owasp-mstg/raw/master/Document/Images/Chapters/0x05c/helloworld.png)](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/Images/Chapters/0x05c/helloworld.png)
...
[![Architectures](https://web.archive.org/web/20201024220933im_/https://github.com/OWASP/owasp-mstg/raw/master/Document/Images/Chapters/0x05c/archs.jpg)](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/Images/Chapters/0x05c/archs.jpg)
...
Most disassemblers can handle any of those architectures. Below, we'll be viewing the armeabi-v7a version (located in `HelloWord-JNI/lib/armeabi-v7a/libnative-lib.so`) in radare2 and in IDA Pro. See the section "[Reviewing Disassembled Native Code](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#reviewing-disassembled-native-code "Reviewing Disassembled Native Code")" below to learn on how to proceed when inspecting the disassembled native code.

##### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#radare2)radare2

To open the file in radare2 you only have to run `r2 -A HelloWord-JNI/lib/armeabi-v7a/libnative-lib.so`. The chapter "[Android Basic Security Testing](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05b-Basic-Security_Testing.md "Android Basic Security Testing")" already introduced radare2. Remember that you can use the flag `-A` to run the `aaa` command right after loading the binary in order to analyze all referenced code.
...
There is a thing that is worth noticing about radare2 vs other disassemblers like e.g. IDA Pro. The following quote from an [article](https://web.archive.org/web/20201024220933/http://radare.today/posts/analysis-by-default/ "radare2 - Analysis By Default") of radare2's blog ([http://radare.today/](https://web.archive.org/web/20201024220933/http://radare.today/)) pretty summarizes this.
...
This said, please see section "[Reviewing Disassembled Native Code](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#reviewing-disassembled-native-code "Reviewing Disassembled Native Code")" to learn more bout how radare2 can help us performing our reversing tasks much faster. For example, getting the disassembly of an specific function is a trivial task that can be performed in one command.

##### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#ida-pro)IDA Pro
...
[![](https://web.archive.org/web/20201024220933im_/https://github.com/OWASP/owasp-mstg/raw/master/Document/Images/Chapters/0x05c/IDA_open_file.jpg)](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/Images/Chapters/0x05c/IDA_open_file.jpg)

> The freeware version of IDA Pro unfortunately does not support the ARM processor type.

[](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#static-analysis)Static Analysis
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
During **black-box testing**, you won't have access to the original form of the source code. You'll usually have the application package in [Android's APK format](https://web.archive.org/web/20201024220933/https://en.wikipedia.org/wiki/Android_application_package "Android application package"), which can be installed on an Android device or reverse engineered as explained in the section "Disassembling and Decompiling".

### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#basic-information-gathering)Basic Information Gathering
...
#### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#retrieving-strings)Retrieving Strings
...
##### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#java-and-kotlin-bytecode)Java and Kotlin Bytecode

As we already know, all the Java and Kotlin bytecode of an Android application is compiled into a DEX file. Each DEX file contains a [list of string identifiers](https://web.archive.org/web/20201024220933/https://source.android.com/devices/tech/dalvik/dex-format#file-layout "string identifiers list") (strings_ids), which contains all the string identifiers used in the binary whenever a string is referred, including internal naming (e.g, type descriptors) or constant objects referred by the code (e.g hardcoded strings). You can simply dump this list using tools such as Ghidra (GUI based) or [Dextra](https://web.archive.org/web/20201024220933/http://newandroidbook.com/tools/dextra.html "Dextra") (CLI based).
...
[![](https://web.archive.org/web/20201024220933im_/https://github.com/OWASP/owasp-mstg/raw/master/Document/Images/Chapters/0x05c/ghidra_dex_strings.png)](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/Images/Chapters/0x05c/ghidra_dex_strings.png)
...
##### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#native-code)Native Code
...
#### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#cross-references)Cross References

##### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#java-and-kotlin)Java and Kotlin

There are many RE tools that support retrieving Java cross references. For many of the GUI-based ones, this is usually done by right clicking on the desired function and selecting the corresponding option, e.g. **Show References to** in Ghidra or [**Find Usage** in jadx](https://web.archive.org/web/20201024220933/https://github.com/skylot/jadx/wiki/jadx-gui-features-overview#find-usage "jadx").

##### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#native-code-1)Native Code
...
#### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#api-usage)API Usage
...
Remember that in most of the cases, just using static analysis will not be enough and might even turn to be extremely inefficient when compared to the dynamic alternatives which will get much more reliable results (e.g. using an interceptor proxy). In this section we've just slightly touched the surface, please refer to the section "[Basic Network Monitoring/Sniffing](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05b-Basic-Security_Testing.md#basic-network-monitoringsniffing "Basic Network Monitoring/Sniffing")" in the "Android Basic Security Testing" chapter and also check the test cases in the chapter "[Android Network APIs](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05g-Testing-Network-Communication.md "Android Network APIs")".

### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#manual-reversed-code-review)Manual (Reversed) Code Review

#### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#reviewing-decompiled-java-code)Reviewing Decompiled Java Code
...
[![](https://web.archive.org/web/20201024220933im_/https://github.com/OWASP/owasp-mstg/raw/master/Document/Images/Chapters/0x05c/check_input.jpg)](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/Images/Chapters/0x05c/check_input.jpg)
...
[![](https://web.archive.org/web/20201024220933im_/https://github.com/OWASP/owasp-mstg/raw/master/Document/Images/Chapters/0x05c/refactored.jpg)](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/Images/Chapters/0x05c/refactored.jpg)
...
#### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#reviewing-disassembled-native-code)Reviewing Disassembled Native Code
...
##### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#radare2-1)radare2
...
The workflow can be further improved by using [r2ghidra-dec](https://web.archive.org/web/20201024220933/https://github.com/radareorg/r2ghidra-dec "r2ghidra-dec"), a deep integration of Ghidra decompiler for radare2. r2ghidra-dec generates decompiled C code, which can aid in quickly analyzing the binary.

##### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#ida-pro-1)IDA Pro
...
[![](https://web.archive.org/web/20201024220933im_/https://github.com/OWASP/owasp-mstg/raw/master/Document/Images/Chapters/0x05c/helloworld_stringfromjni.jpg)](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/Images/Chapters/0x05c/helloworld_stringfromjni.jpg)
...
[![](https://web.archive.org/web/20201024220933im_/https://github.com/OWASP/owasp-mstg/raw/master/Document/Images/Chapters/0x05c/JNI_interface.png)](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/Images/Chapters/0x05c/JNI_interface.png)
...
##### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#ghidra)Ghidra
...
[![](https://web.archive.org/web/20201024220933im_/https://github.com/OWASP/owasp-mstg/raw/master/Document/Images/Chapters/0x05c/Ghidra_decompiled_function.png)](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/Images/Chapters/0x05c/Ghidra_decompiled_function.png)

### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#automated-static-analysis)Automated Static Analysis
...
-   [QARK](https://web.archive.org/web/20201024220933/https://github.com/linkedin/qark/ "QARK")
-   [Androbugs](https://web.archive.org/web/20201024220933/https://github.com/AndroBugs/AndroBugs_Framework "Androbugs")
-   [JAADAS](https://web.archive.org/web/20201024220933/https://github.com/flankerhqd/JAADAS "JAADAS")
-   [MobSF](https://web.archive.org/web/20201024220933/https://github.com/MobSF/Mobile-Security-Framework-MobSF "MobSF")

For commercial tools, see the section "[Static Source Code Analysis (Commercial Tools)](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x08-Testing-Tools.md#static-source-code-analysis-commercial-tools "Static Source Code Analysis (Commercial Tools)")" in the chapter "Testing Tools".

[](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#dynamic-analysis)Dynamic Analysis
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Analysis can be assisted by automated tools, such as [MobSF](https://web.archive.org/web/20201024220933/https://github.com/MobSF/Mobile-Security-Framework-MobSF/ "MobSF"), while assessing an application. An application can be assessed by side-loading it, re-packaging it, or by simply attacking the installed version.

### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#dynamic-analysis-on-non-rooted-devices)Dynamic Analysis on Non-Rooted Devices
...
In order to dynamically analyze the application, you can also rely on [objection](https://web.archive.org/web/20201024220933/https://github.com/sensepost/objection "objection") which is leveraging Frida. However, in order to be able to use objection on non-rooted devices you have to perform one additional step: [patch the APK](https://web.archive.org/web/20201024220933/https://github.com/sensepost/objection/wiki/Patching-Android-Applications#patching---patching-an-apk "patching - patching an APK") to include the [Frida gadget](https://web.archive.org/web/20201024220933/https://www.frida.re/docs/gadget/ "Frida Gadget") library. Objection communicates then using a Python API with the mobile phone through the installed Frida gadget.
...
### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#basic-information-gathering-1)Basic Information Gathering

As mentioned previously, Android runs on top of a modified Linux kernel and retains the [proc filesystem](https://web.archive.org/web/20201024220933/https://www.kernel.org/doc/Documentation/filesystems/proc.txt "procfs") (procfs) from Linux, which is mounted at `/proc`. Procfs provides a directory-based view of a process running on the system, providing detailed information about the process itself, its threads, and other system-wide diagnostics. Procfs is arguably one of the most important filesystems on Android, where many OS native tools depend on it as their source of information.
...
#### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#open-files)Open Files

You can use `lsof` with the flag `-p <pid>` to return the list of open files for the specified process. See the [man page](https://web.archive.org/web/20201024220933/http://man7.org/linux/man-pages/man8/lsof.8.html "Man Page of lsof") for more options.
...
#### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#open-connections)Open Connections
...
#### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#loaded-native-libraries)Loaded Native Libraries
...
#### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#sandbox-inspection)Sandbox Inspection

The application data is stored in a sandboxed directory present at `/data/data/<app_package_name>`. The content of this directory has already been discussed in detail in the "[Accessing App Data Directories](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05b-Basic-Security_Testing.md#accessing-app-data-directories "Accessing App Data Directories")" section.

### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#debugging)Debugging
...
#### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#debugging-release-apps)Debugging Release Apps
...
#### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#debugging-with-jdb)Debugging with jdb
...
[![Waiting For Debugger](https://web.archive.org/web/20201024220933im_/https://github.com/OWASP/owasp-mstg/raw/master/Document/Images/Chapters/0x05c/waitfordebugger.png)](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/Images/Chapters/0x05c/waitfordebugger.png)

Now you can set breakpoints and attach to the Uncrackable1 app process with the "Attach Debugger" toolbar button.

[![](https://web.archive.org/web/20201024220933im_/https://github.com/OWASP/owasp-mstg/raw/master/Document/Images/Chapters/0x05c/set_breakpoint_and_attach_debugger.png)](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/Images/Chapters/0x05c/set_breakpoint_and_attach_debugger.png)
...
[![Choose Process](https://web.archive.org/web/20201024220933im_/https://github.com/OWASP/owasp-mstg/raw/master/Document/Images/Chapters/0x05c/Choose_Process.png)](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/Images/Chapters/0x05c/Choose_Process.png)
...
[![](https://web.archive.org/web/20201024220933im_/https://github.com/OWASP/owasp-mstg/raw/master/Document/Images/Chapters/0x05c/Force_Step_Into.png)](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/Images/Chapters/0x05c/Force_Step_Into.png)
...
[![](https://web.archive.org/web/20201024220933im_/https://github.com/OWASP/owasp-mstg/raw/master/Document/Images/Chapters/0x05c/fucntion_a_of_class_sg_vantagepoint_a.png)](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/Images/Chapters/0x05c/fucntion_a_of_class_sg_vantagepoint_a.png)
...
[![](https://web.archive.org/web/20201024220933im_/https://github.com/OWASP/owasp-mstg/raw/master/Document/Images/Chapters/0x05c/step_over.png)](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/Images/Chapters/0x05c/step_over.png)
...
[![](https://web.archive.org/web/20201024220933im_/https://github.com/OWASP/owasp-mstg/raw/master/Document/Images/Chapters/0x05c/step_out.png)](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/Images/Chapters/0x05c/step_out.png)
...
[![](https://web.archive.org/web/20201024220933im_/https://github.com/OWASP/owasp-mstg/raw/master/Document/Images/Chapters/0x05c/set_value.png)](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/Images/Chapters/0x05c/set_value.png)

[![](https://web.archive.org/web/20201024220933im_/https://github.com/OWASP/owasp-mstg/raw/master/Document/Images/Chapters/0x05c/modified_binary_name.png)](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/Images/Chapters/0x05c/modified_binary_name.png)

Once you modify the binary name or the directory name, `File.exists` should return `false`.

[![](https://web.archive.org/web/20201024220933im_/https://github.com/OWASP/owasp-mstg/raw/master/Document/Images/Chapters/0x05c/file_exists_false.png)](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/Images/Chapters/0x05c/file_exists_false.png)
...
[![Anti Debugging and Tampering Defeated](https://web.archive.org/web/20201024220933im_/https://github.com/OWASP/owasp-mstg/raw/master/Document/Images/Chapters/0x05c/anti_debug_anti_tamper_defeated.png)](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/Images/Chapters/0x05c/anti_debug_anti_tamper_defeated.png)

[![](https://web.archive.org/web/20201024220933im_/https://github.com/OWASP/owasp-mstg/raw/master/Document/Images/Chapters/0x05c/MainActivity_verify.png)](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/Images/Chapters/0x05c/MainActivity_verify.png)
...
[![](https://web.archive.org/web/20201024220933im_/https://github.com/OWASP/owasp-mstg/raw/master/Document/Images/Chapters/0x05c/sg_vantagepoint_uncrackable1_a_function_a.png)](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/Images/Chapters/0x05c/sg_vantagepoint_uncrackable1_a_function_a.png)

You can see the secret string in the "Variables" view when you reach the `String.equals` method call.

[![](https://web.archive.org/web/20201024220933im_/https://github.com/OWASP/owasp-mstg/raw/master/Document/Images/Chapters/0x05c/secret_code.png)](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/Images/Chapters/0x05c/secret_code.png)

[![Success](https://web.archive.org/web/20201024220933im_/https://github.com/OWASP/owasp-mstg/raw/master/Document/Images/Chapters/0x05c/success.png)](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/Images/Chapters/0x05c/success.png)

#### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#debugging-native-code)Debugging Native Code
...
### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#tracing)Tracing

#### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#execution-tracing)Execution Tracing
...
##### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#tracing-system-calls)Tracing System Calls
...
##### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#ftrace)Ftrace
...
##### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#kprobes)KProbes
...
#### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#method-tracing)Method Tracing
...
#### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#native-code-tracing)Native Code Tracing
...
[![](https://web.archive.org/web/20201024220933im_/https://github.com/OWASP/owasp-mstg/raw/master/Document/Images/Chapters/0x05c/frida_trace_native_functions.png)](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/Images/Chapters/0x05c/frida_trace_native_functions.png)

Note how, by default, only the arguments passed to the function are shown, but not the return values. Under the hood, `frida-trace` generates one little JavaScript handler file per matched function in the auto-generated `__handlers__` folder, which Frida then injects into the process. You can edit these files for more advanced usage such as obtaining the return value of the functions, their input parameters, accessing the memory, etc. Check Frida's [JavaScript API](https://web.archive.org/web/20201024220933/https://www.frida.re/docs/javascript-api/ "JavaScript API") for more details.
...
Refer to the [Release Notes](https://web.archive.org/web/20201024220933/https://frida.re/news/2020/06/29/frida-12-10-released/ "Frida 12.10") for more details. To learn more about all options for advanced usage, check the [documentation on the official Frida website](https://web.archive.org/web/20201024220933/https://frida.re/docs/frida-trace/ "documentation").

#### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#jni-tracing)JNI Tracing

As detailed in section [Reviewing Disassembled Native Code](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#reviewing-disassembled-native-code), the first argument passed to every JNI function is a JNI interface pointer. This pointer contains a table of functions that allows native code to access the Android Runtime. Identifying calls to these functions can help with understanding library functionality, such as what strings are created or Java methods are called.

[jnitrace](https://web.archive.org/web/20201024220933/https://github.com/chame1eon/jnitrace "jnitrace") is a Frida based tool similar to frida-trace which specifically targets the usage of Android's JNI API by native libraries, providing a convenient way to obtain JNI method traces including arguments and return values.
...
[![](https://web.archive.org/web/20201024220933im_/https://github.com/OWASP/owasp-mstg/raw/master/Document/Images/Chapters/0x05c/jni_tracing_helloworldjni.png)](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/Images/Chapters/0x05c/jni_tracing_helloworldjni.png)

In the output you can see the trace of a call to `NewStringUTF` made from the native code (its return value is then given back to Java code, see section "[Reviewing Disassembled Native Code](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#reviewing-disassembled-native-code)" for more details). Note how similarly to frida-trace, the output is colorized helping to visually distinguish the different threads.
...
To learn more about all options for advanced usage, check the [documentation on the jnitrace GitHub page](https://web.archive.org/web/20201024220933/https://github.com/chame1eon/jnitrace "documentation").

### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#emulation-based-analysis)Emulation-based Analysis
...
#### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#droidscope)DroidScope

DroidScope (an extension to the [DECAF dynamic analysis framework](https://web.archive.org/web/20201024220933/https://github.com/sycurelab/DECAF "DECAF dynamic analysis framework"))is a malware analysis engine based on QEMU. It instruments the emulated environment on several context levels, making it possible to fully reconstruct the semantics on the hardware, Linux and Java levels.
...
#### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#vxstripper)VxStripper

Another very useful tool built on QEMU is [VxStripper by Sébastien Josse](https://web.archive.org/web/20201024220933/http://vxstripper.pagesperso-orange.fr/ "VxStripper"). VXStripper is specifically designed for de-obfuscating binaries. By instrumenting QEMU's dynamic binary translation mechanisms, it dynamically extracts an intermediate representation of a binary. It then applies simplifications to the extracted intermediate representation and recompiles the simplified binary with LLVM. This is a very powerful way of normalizing obfuscated programs. See [Sébastien's paper](https://web.archive.org/web/20201024220933/http://ieeexplore.ieee.org/document/6759227/ "Dynamic Malware Recompilation") for more information [#josse].

### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#binary-analysis)Binary Analysis
...
#### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#symbolic-execution)Symbolic Execution
...
[![](https://web.archive.org/web/20201024220933im_/https://github.com/OWASP/owasp-mstg/raw/master/Document/Images/Chapters/0x05c/disass_main_1874.png)](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/Images/Chapters/0x05c/disass_main_1874.png)
...
[![](https://web.archive.org/web/20201024220933im_/https://github.com/OWASP/owasp-mstg/raw/master/Document/Images/Chapters/0x05c/graph_1874.png)](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/Images/Chapters/0x05c/graph_1874.png)
...
[![](https://web.archive.org/web/20201024220933im_/https://github.com/OWASP/owasp-mstg/raw/master/Document/Images/Chapters/0x05c/loop_1784.png)](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/Images/Chapters/0x05c/loop_1784.png)
...
[![](https://web.archive.org/web/20201024220933im_/https://github.com/OWASP/owasp-mstg/raw/master/Document/Images/Chapters/0x05c/values_compare_17dc.png)](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/Images/Chapters/0x05c/values_compare_17dc.png)
...
[![](https://web.archive.org/web/20201024220933im_/https://github.com/OWASP/owasp-mstg/raw/master/Document/Images/Chapters/0x05c/graph_ifelse_1760.png)](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/Images/Chapters/0x05c/graph_ifelse_1760.png)
...
[](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#tampering-and-runtime-instrumentation)Tampering and Runtime Instrumentation
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#patching-repackaging-and-re-signing)Patching, Repackaging, and Re-Signing
...
#### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#patching-example-disabling-certificate-pinning)Patching Example: Disabling Certificate Pinning
...
#### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#patching-example-making-an-app-debuggable)Patching Example: Making an App Debuggable
...
#### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#repackaging)Repackaging
...
#### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#re-signing)Re-Signing
...
#### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#the-wait-for-debugger-feature)The "Wait For Debugger" Feature
...
[![Debugger Detection](https://web.archive.org/web/20201024220933im_/https://github.com/OWASP/owasp-mstg/raw/master/Document/Images/Chapters/0x05c/debugger_detection.png)](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/Images/Chapters/0x05c/debugger_detection.png)

In the Developer options, pick `Uncrackable1` as the debugging application and activate the "Wait for Debugger" switch.

[![Developer Options](https://web.archive.org/web/20201024220933im_/https://github.com/OWASP/owasp-mstg/raw/master/Document/Images/Chapters/0x05c/developer-options.png)](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/Images/Chapters/0x05c/developer-options.png)
...
#### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#patching-react-native-applications)Patching React Native applications

If the [React Native](https://web.archive.org/web/20201024220933/https://facebook.github.io/react-native "React Native") framework has been used for developing then the main application code is located in the file `assets/index.android.bundle`. This file contains the JavaScript code. Most of the time, the JavaScript code in this file is minified. By using the tool [JStillery](https://web.archive.org/web/20201024220933/https://mindedsecurity.github.io/jstillery "JStillery") a human readable version of the file can be retried, allowing code analysis. The [CLI version of JStillery](https://web.archive.org/web/20201024220933/https://github.com/mindedsecurity/jstillery/ "CLI version of JStillery") or the local server should be preferred instead of using the online version as otherwise source code is sent and disclosed to a 3rd party.
...
#### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#library-injection)Library Injection
...
Using library injection you can develop reusable libraries and inject them to different applications, effectively making them behave differently without having to modify their original source code. This is known as DLL injection on Windows (broadly used to modify and bypass anti-cheat mechanisms in games), `LD_PRELOAD` on Linux and `DYLD_INSERT_LIBRARIES` on macOS. On Android and iOS, a common example is using the Frida Gadget whenever Frida's so-called [Injected mode](https://web.archive.org/web/20201024220933/https://frida.re/docs/modes/#injected "Frida Injected Mode") of operation isn't suitable (i.e. you cannot run the Frida server on the target device). In this situation, you can [inject the Gadget](https://web.archive.org/web/20201024220933/https://frida.re/docs/gadget/ "Frida Gadget") library by using the same methods you're going to learn in this section.
...
##### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#patching-the-applications-smali-code)Patching the Application's Smali Code
...
Ideally you should insert the above code early in the [application lifecycle](https://web.archive.org/web/20201024220933/https://developer.android.com/guide/components/activities/activity-lifecycle "Understand the Activity Lifecycle"), for instance in the `onCreate` method. It is important to remember to add the library libinject.so in the respective architecture folder (armeabi-v7a, arm64-v8a, x86) of the `lib` folder in the APK. Finally, you need to re-sign the application before using it.

A well-known use case of this technique is loading the Frida gadget to an application, specially while working on a non-rooted device (this is what [`objection patchapk`](https://web.archive.org/web/20201024220933/https://github.com/sensepost/objection/wiki/Patching-Android-Applications "Patching Android Applications") basically does).

##### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#patching-applications-native-library)Patching Application's Native Library
...
Modifying the ELF file structure manually to inject a library can be cumbersome and prone to errors. However, this task can be performed with relative ease using [LIEF](https://web.archive.org/web/20201024220933/https://lief.quarkslab.com/ "LIEF") (Library to Instrument Executable Formats). Using it requires only a few lines of Python code as shown below:
...
In the above example, libinject.so library is injected as a dependency of a native library (libnative.so), which the application already loads by default. Frida gadget can be injected into an application using this approach as explained in detail in [LIEF's documentation](https://web.archive.org/web/20201024220933/https://lief.quarkslab.com/doc/latest/tutorials/09_frida_lief.html "LIEF's documentation - How to use frida on a non-rooted device"). As in the previous section, it is important to remember adding the library to the respective architecture `lib` folder in the APK and finally re-signing the application.

##### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#preloading-symbols)Preloading Symbols
...
### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#dynamic-instrumentation)Dynamic Instrumentation

#### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#information-gathering)Information Gathering

In this section we will learn about how to use Frida to obtain information about a running application.

##### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#getting-loaded-classes-and-their-methods)Getting Loaded Classes and their Methods

You can use the command `Java` in the Frida CLI to access the Java runtime and retrieve information from the running app. Remember that, unlike Frida for iOS, in Android you need to wrap your code inside a `Java.perform` function. Thus, it's more convenient to use Frida scripts to e.g. get a list of loaded Java classes and their corresponding methods and fields or for more complex information gathering or instrumentation. One such scripts is listed below. The script to list class's methods used below is available on [Github](https://web.archive.org/web/20201024220933/https://github.com/frida/frida-java-bridge/issues/44 "Github").
...
##### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#getting-loaded-libraries)Getting Loaded Libraries
...
#### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#method-hooking)Method Hooking

##### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#xposed)Xposed
...
Just like regular Android apps, modules for Xposed are developed and deployed with Android Studio. For more details on writing, compiling, and installing Xposed modules, refer to the tutorial provided by its author, [rovo89](https://web.archive.org/web/20201024220933/https://www.xda-developers.com/rovo89-updates-on-the-situation-regarding-xposed-for-nougat/ "Rovo89: Update on Development of Xposed for Nougat").

##### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#frida)Frida
...
[![Crackme Root Detected Dialog](https://web.archive.org/web/20201024220933im_/https://github.com/OWASP/owasp-mstg/raw/master/Document/Images/Chapters/0x05c/crackme-frida-1.png)](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/Images/Chapters/0x05c/crackme-frida-1.png)
...
#### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#process-exploration)Process Exploration
...
In the following sections you will be using r2frida to retrieve information straight from the app runtime. Please refer to [r2frida's official installation instructions](https://web.archive.org/web/20201024220933/https://github.com/nowsecure/r2frida/blob/master/README.md#installation "r2frida installation instructions"). First start by opening an r2frida session to the target app (e.g. [HelloWorld JNI](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/raw/master/Samples/Android/01_HelloWorld-JNI/HelloWord-JNI.apk "HelloWorld JNI") APK) that should be running on your Android phone (connected per USB). Use the following command:
...
##### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#memory-maps-and-inspection)Memory Maps and Inspection
...
##### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#in-memory-search)In-Memory Search
...
Additionally, you can search for occurrences of the [wide version of the string](https://web.archive.org/web/20201024220933/https://en.wikipedia.org/wiki/Wide_character "Wide character") (`\/w`) and, again, check their memory regions:
...
In addition, you could use this approach to locate and extract cryptographic keys. For instance, in the case of an app encrypting/decrypting data and handling keys in memory instead of using the AndroidKeyStore API. See the section "[Testing Key Management](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05e-Testing-Cryptography.md#testing-key-management-mstg-storage-1-mstg-crypto-1-and-mstg-crypto-5 "Testing Key Management")" in the chapter "[Android Cryptographic APIs](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05e-Testing-Cryptography.md)" for more details.

##### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#memory-dump)Memory Dump

You can dump the app's process memory with [objection](https://web.archive.org/web/20201024220933/https://github.com/sensepost/objection "Objection") and [Fridump](https://web.archive.org/web/20201024220933/https://github.com/Nightbringer21/fridump "Fridump"). To take advantage of these tools on a non-rooted device, the Android app must be repackaged with `frida-gadget.so` and re-signed. A detailed explanation of this process is in the section "[Dynamic Analysis on Non-Rooted Devices](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#dynamic-analysis-on-non-rooted-devices "Dynamic Analysis on Non-Rooted Devices"). To use these tools on a rooted phone, simply have frida-server installed and running.
...
Alternatively you can use Fridump. This time, we will input a string and see if we can find it in the memory dump. For this, open the [MSTG Hacking Playground](https://web.archive.org/web/20201024220933/https://github.com/OWASP/MSTG-Hacking-Playground/tree/master/Android "MSTG Hacking Playground") app, navigate to "OMTG_DATAST_002_LOGGING" and enter "owasp-mstg" to the password field. Next, run Fridump:
...
##### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#runtime-reverse-engineering)Runtime Reverse Engineering
...
To learn more, please refer to the [r2frida wiki](https://web.archive.org/web/20201024220933/https://github.com/enovella/r2frida-wiki/blob/master/README.md "r2frida Wiki").

[](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#customizing-android-for-reverse-engineering)Customizing Android for Reverse Engineering
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#customizing-the-ramdisk)Customizing the RAMDisk
...
### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#customizing-the-android-kernel)Customizing the Android Kernel
...
[https://source.android.com/source/building-kernels.html#id-version](https://web.archive.org/web/20201024220933/https://source.android.com/source/building-kernels.html#id-version)
...
### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#booting-the-custom-environment)Booting the Custom Environment
...
[![Custom Kernel](https://web.archive.org/web/20201024220933im_/https://github.com/OWASP/owasp-mstg/raw/master/Document/Images/Chapters/0x05c/custom_kernel.jpg)](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/Images/Chapters/0x05c/custom_kernel.jpg)

### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#system-call-hooking-with-kernel-modules)System Call Hooking with Kernel Modules
...
[![](https://web.archive.org/web/20201024220933im_/https://github.com/OWASP/owasp-mstg/raw/master/Document/Images/Chapters/0x05c/syscall_hooking.jpg)](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/Images/Chapters/0x05c/syscall_hooking.jpg)
...
#### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#example-file-hiding)Example: File Hiding
...
[](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#references)References
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------

-   Bionic - [https://github.com/android/platform_bionic](https://web.archive.org/web/20201024220933/https://github.com/android/platform_bionic)
-   Attacking Android Applications with Debuggers (19 January 2015) - [https://blog.netspi.com/attacking-android-applications-with-debuggers/](https://web.archive.org/web/20201024220933/https://blog.netspi.com/attacking-android-applications-with-debuggers/)
-   [#josse] Sébastien Josse, Dynamic Malware Recompilation (6 January 2014) - [http://ieeexplore.ieee.org/document/6759227/](https://web.archive.org/web/20201024220933/http://ieeexplore.ieee.org/document/6759227/)
-   Update on Development of Xposed for Nougat - [https://www.xda-developers.com/rovo89-updates-on-the-situation-regarding-xposed-for-nougat/](https://web.archive.org/web/20201024220933/https://www.xda-developers.com/rovo89-updates-on-the-situation-regarding-xposed-for-nougat/)
-   Android Platform based Linux kernel rootkit (4 April 2011 - Phrack Magazine)
-   [#mueller] Bernhard Mueller, Hacking Soft Tokens. Advanced Reverse Engineering on Android (2016) - [https://packetstormsecurity.com/files/138504/HITB_Hacking_Soft_Tokens_v1.2.pdf](https://web.archive.org/web/20201024220933/https://packetstormsecurity.com/files/138504/HITB_Hacking_Soft_Tokens_v1.2.pdf)

### [](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05c-Reverse-Engineering-and-Tampering.md#tools)Tools

-   Angr - [https://angr.io/](https://web.archive.org/web/20201024220933/https://angr.io/)
-   APKEnum - [https://github.com/shivsahni/APKEnum](https://web.archive.org/web/20201024220933/https://github.com/shivsahni/APKEnum)
-   apktool - [https://github.com/iBotPeaches/Apktool](https://web.archive.org/web/20201024220933/https://github.com/iBotPeaches/Apktool)
-   apkx - [https://github.com/b-mueller/apkx](https://web.archive.org/web/20201024220933/https://github.com/b-mueller/apkx)
-   CFR Decompiler - [https://www.benf.org/other/cfr/](https://web.archive.org/web/20201024220933/https://www.benf.org/other/cfr/)
-   Dextra - [http://newandroidbook.com/tools/dextra.html](https://web.archive.org/web/20201024220933/http://newandroidbook.com/tools/dextra.html)
-   IDA Pro - [https://www.hex-rays.com/products/ida/](https://web.archive.org/web/20201024220933/https://www.hex-rays.com/products/ida/)
-   JAD Decompiler - [http://www.javadecompilers.com/jad](https://web.archive.org/web/20201024220933/http://www.javadecompilers.com/jad)
-   jadx - [https://github.com/skylot/jadx](https://web.archive.org/web/20201024220933/https://github.com/skylot/jadx)
-   JD (Java Decompiler) - [http://jd.benow.ca/](https://web.archive.org/web/20201024220933/http://jd.benow.ca/)
-   JEB Decompiler - [https://www.pnfsoftware.com](https://web.archive.org/web/20201024220933/https://www.pnfsoftware.com/)
-   OWASP Mobile Testing Guide Crackmes - [https://github.com/OWASP/owasp-mstg/blob/master/Crackmes/](https://web.archive.org/web/20201024220933/https://github.com/OWASP/owasp-mstg/blob/master/Crackmes/)
-   Procyon Decompiler - [https://bitbucket.org/mstrobel/procyon/overview](https://web.archive.org/web/20201024220933/https://bitbucket.org/mstrobel/procyon/overview)
-   Radare2 - [https://www.radare.org](https://web.archive.org/web/20201024220933/https://www.radare.org/)
-   smalidea plugin for IntelliJ - [https://github.com/JesusFreke/smalidea](https://web.archive.org/web/20201024220933/https://github.com/JesusFreke/smalidea)
-   VxStripper - [http://vxstripper.pagesperso-orange.fr](https://web.archive.org/web/20201024220933/http://vxstripper.pagesperso-orange.fr/)