...
<section id="bootstrap-wrapper">
  ...
  <div class="row">
    <div class="col-lg-6 col-12 mb-2">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">What is the use of the Clan Contribution</h5>
    ...
    <div class="col-lg-6 col-12 mb-2">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">How to get Clan Contribution</h5>
          <div class="card-text">
            <ul>
              <li>
    ...
    <div class="col-lg-6 col-12 mb-2">
      <h2 id="cookable">Clan Contribution is a cooking ingredient for</h2>
    </div>
    <div class="col-12 mb-2">
      <h5>Clan Contribution Spawn Locations</h5>
