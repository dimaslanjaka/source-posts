...
<section id="bootstrap-wrapper">
  ...
  >
    <div class="col p-4 d-flex flex-column position-static">
      ...
      <a href="#" class="stretched-link d-none">Continue reading Pirarucu</a>
    </div>
  ...
  <div class="row">
    <div class="col-lg-6 col-12 mb-2">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">What is the use of the Pirarucu</h5>
    ...
    <div class="col-lg-6 col-12 mb-2">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">How to get Pirarucu</h5>
          <div class="card-text">
            <ul>
