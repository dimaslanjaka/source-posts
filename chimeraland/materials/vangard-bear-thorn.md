...
<section id="bootstrap-wrapper">
  ...
  >
    <div class="col p-4 d-flex flex-column position-static">
      ...
      <h3 class="mb-0">Vangard Bear Thorn</h3>
  ...
  <div class="row">
    <div class="col-lg-6 col-12 mb-2">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">What is the use of the Vangard Bear Thorn</h5>
          <div class="card-text">
            <ul>
    ...
    <div class="col-lg-6 col-12 mb-2">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">How to get Vangard Bear Thorn</h5>
          <div class="card-text">
            <ul>
    ...
    <div class="col-12 mb-2">
      <h2 id="cookable">Cooking Recipes Using Vangard Bear Thorn</h2>
    </div>
    <div class="col-12 mb-2">
