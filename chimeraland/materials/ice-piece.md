...
<section id="bootstrap-wrapper">
  ...
  <div class="row">
    <div class="col-lg-6 col-12 mb-2">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">What is the use of the Ice Piece</h5>
          <div class="card-text">
            <ul>
              <li>
    ...
    <div class="col-lg-6 col-12 mb-2">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">How to get Ice Piece</h5>
          <div class="card-text">
            <ul>
    ...
    <div class="col-lg-6 col-12 mb-2">
                ...
                <ul>
                  <li>
                    ...
                    <a
                      ...
                      >Dew</a
                    >
                    + Any Meat + Any High Quality Seasoning + Any Flower / Any
                    Mutant Flower
                  </li>
                  <li>Device: Stove or Camp</li>
                </ul>
                ...
                <ul>
                  <li>
                    ...
                    <a
                      ...
                      >Dew</a
                    >
                    + Any Mixed Sauce + Any Meat + Any Meat + Any High Quality
                    Seasoning
                  </li>
                  <li>Device: Stove or Camp</li>
                </ul>
      ...
      <div id="recipe-cantaloupe-slushie">
        <h5 id="item-cantaloupe-slushie">Cantaloupe Slushie</h5>
        <div class="col-12 col-lg-6 recipe-item mb-2">
          <div class="card">
            <div class="card-body">
                ...
                <ul>
                  <li>
                    ...
                    <a
                      ...
                      >Ice Piece</a
                    >
                    + Any Lv.6 Crop + Any Spice + Orange grade fish / Red grade
                    fish
                  </li>
                  <li>Device: Stove or Camp</li>
                </ul>
                ...
                <ul>
                  <li>
                    ...
                    <a
                      ...
                      >Ice Piece</a
                    >
                    + Blue grade fish / Purple grade fish / Orange grade fish /
                    Red grade fish
                  </li>
                  <li>Device: Stove or Camp</li>
                </ul>
                ...
                <ul>
                  <li>
                    ...
                    <a
                      ...
                      >Ice Piece</a
                    >
                    + Any High Quality Seasoning + Any Meat + Any Spice + Any
                    Lv.5 Crop / Any Lv.6 Crop
                  </li>
                  <li>Device: Stove or Camp</li>
                </ul>
              </div>
                ...
                <ul>
                  <li>
                    ...
                    <a
                      ...
                      >Ice Piece</a
                    >
                    + Any Seasoning + Any Lv.5 Crop / Any Lv.6 Crop
                  </li>
                  <li>Device: Stove or Camp</li>
                </ul>
              </div>
      ...
      <div id="recipe-ice-block">
        <h5 id="item-ice-block">Ice Block</h5>
        <div class="col-12 col-lg-6 recipe-item mb-2">
          <div class="card">
            <div class="card-body">
                ...
                <ul>
                  <li>
                    ...
                    <a
                      ...
                      >Ice Piece</a
                    >
                    + Any Lv.6 Crop + Any Meat + Any Lv.6 Crop
                  </li>
                  <li>Device: Stove or Camp</li>
                </ul>
              </div>
                ...
                <ul>
                  <li>
                    <a
                      ...
                      >dew</a
                    >
                    + crop level 6 + Any Meat + crop level 6
                  </li>
                  <li>Device: Stove or Camp</li>
                </ul>
              </div>
      ...
      <div id="recipe-sea-buckthorn-slushie">
        <h5 id="item-sea-buckthorn-slushie">Sea-Buckthorn Slushie</h5>
        <div class="col-12 col-lg-6 recipe-item mb-2">
          <div class="card">
            <div class="card-body">
                ...
                <ul>
                  <li>
                    ...
                    <a
                      ...
                      >Ice Piece</a
                    >
                    + Any Meat + Orange grade fish / Red grade fish
                  </li>
                  <li>Device: Stove or Camp</li>
                </ul>
              </div>
                ...
                <ul>
                  <li>
                    <a
                      ...
                      >Gratoise Meat</a
                    >
                    + Dew or Ice Piece + Any Seasoning + Any Lv.5 Crop / Any
                    Lv.6 Crop
                  </li>
                  <li>Device: Stove or Camp</li>
                </ul>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="card-text">
                <ul>
                  <li>
                    Job&#x27;s Tears Powder + Job&#x27;s Tears Powder +
                    <a
                      class="text-decoration-none"
                      href="/chimeraland/materials/dew.html"
                      >Dew</a
    ...
    <div class="col-12 mb-2">
      <h5>Ice Piece Spawn Locations</h5>
