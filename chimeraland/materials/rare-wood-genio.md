...
<section id="bootstrap-wrapper">
  ...
  >
    <div class="col p-4 d-flex flex-column position-static">
      ...
      <h3 class="mb-0">Rare Wood Genio</h3>
  ...
  <div class="row">
    <div class="col-lg-6 col-12 mb-2">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">What is the use of the Rare Wood Genio</h5>
    ...
    <div class="col-lg-6 col-12 mb-2">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">How to get Rare Wood Genio</h5>
          <div class="card-text">
            <ul>
    ...
    <div class="col-lg-6 col-12 mb-2">
      <h2 id="cookable">Rare Wood Genio is a cooking ingredient for</h2>
    </div>
    <div class="col-12 mb-2">
      <h5>Rare Wood Genio Spawn Locations</h5>
