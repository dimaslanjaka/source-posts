          ...
          <tr>
            <td>
              <img
                ...
                src="/chimeraland/recipes/scraps-claypot/scraps-claypot-icon.webp"
                width="auto"
                height="auto"
              />
            </td>
            <td><h1 class="fs-5">Scraps Claypot Cooking Recipe</h1></td>
          </tr>
        </tbody>
      </table>
    </div>
  ...
  <div class="card mb-2">
    <div class="row g-0">
      <div class="col-sm-4 position-relative mb-2">
        <img
          src="/chimeraland/recipes/scraps-claypot/scraps-claypot-material.webp"
