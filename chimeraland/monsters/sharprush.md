...
<section id="bootstrap-wrapper">
  <div data-bs-theme="dark">
    <h2>Sharprush Information from Chimeraland</h2>
    <h2 id="attribute"><i>Sharprush</i> default maximum attribute</h2>
    <div class="row">
      <div class="col mb-2">
        <div class="card">
          <div class="card-body">
    ...
    <hr />
    <h2 id="delicacies">Delicacies/Tasty for Sharprush</h2>
    <div class="card">
      <div class="card-body">
