...
description: "Attendant Rosary Fortuna Rosary Fortuna Information from
  ...
  \    Rosary Fortuna default maximum attribute
...
<section id="bootstrap-wrapper">
  <div data-bs-theme="dark">
    <h2>Rosary Fortuna Information from Chimeraland</h2>
    <h2 id="attribute"><i>Rosary Fortuna</i> default maximum attribute</h2>
    <div class="row">
      <div class="col mb-2">
        <div class="card">
          <div class="card-body">
    ...
    <blockquote class="bd-callout bd-callout-warning">
      Note: Rosary Fortuna stat will increase based on their <b>grade</b> and
      <b>delicacies/tasty</b>.
    </blockquote>
    <hr />
    <h2 id="delicacies">Delicacies/Tasty for Rosary Fortuna</h2>
    <div class="card">
      <div class="card-body">
